...
//version 2 of get weather with no navigator used
...
//version 1 of get weather with navigator
/*
var getWeather = function() {
...
function displayWeather(object) {
   ...
   temperatureIcon.src = "https://cdn4.iconfinder.com/data/icons/medicons-2/512/thermometer-512.png";
    ...
    //document.getElementById("current-weather-date").innerHTML = m + "/" + d + "/" + y;
    document.getElementById("current-weather-date").innerHTML = monthNames[m] + " " + d + ", " + y;
    
      
    //Get 24hour time
    var time2 = n.toLocaleTimeString();
 
    document.getElementById("current-weather-time").innerHTML = time2;
